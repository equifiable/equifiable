          ...
          <div className="bg-blue-900 rounded-lg shadow-lg p-8 max-w-[400px] mx-auto">
            <form>
              ...
              <div className="mt-6 space-y-5">
                ...
                <Link className="font-medium text-indigo-500" href="/dashboard">Force login company</Link>
                <Link className="font-medium text-indigo-500" href="/employee/">Force login client</Link>
