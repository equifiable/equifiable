      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="flex justify-center mb-8">
            <button
              className={`px-4 py-2 text-sm font-medium ${loginType === "client" ? "text-indigo-500 border-b-2 border-indigo-500" : "text-gray-500"}`}
              onClick={() => setLoginType("client")}
            >
              Client Login
            </button>
            <button
              className={`ml-4 px-4 py-2 text-sm font-medium ${loginType === "company" ? "text-indigo-500 border-b-2 border-indigo-500" : "text-gray-500"}`}
          ...
          {/* Card */}
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-[400px] mx-auto">
            <form>
              ...
              <div className="mt-6 space-y-5">
                <button className="btn w-full bg-gradient-to-t from-indigo-600 to-indigo-500 bg-[length:100%_100%] bg-[bottom] text-white shadow-[inset_0px_1px_0px_0px_theme(colors.white/.16)] hover:bg-[length:100%_150%]">
                  {loginType === "client" ? "Sign in as Client" : "Sign in as Company"}
                </button>
